...
class MedicalSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $medPediatrie = Medecin::where('specialite', 'Pédiatrie')->first();
        $medDermato   = Medecin::where('specialite', 'Dermatologie')->first();
        $medNeuro     = Medecin::where('specialite', 'Neurologie')->first();
        $medGyneco    = Medecin::where('specialite', 'Gynécologie')->first();
        $medOphtalmo  = Medecin::where('specialite', 'Ophtalmologie')->first();
        $medRhumato   = Medecin::where('specialite', 'Rhumatologie')->first();
        ...
        $rdv3 = RendezVous::create(['date_heure' => now()->subDays(12), 'statut' => 'termine', 'motif' => 'Contrôle croissance', 'patient_id' => $patients[2]->id, 'medecin_id' => $medPediatrie->id]);
        ...
        $rdv5 = RendezVous::create(['date_heure' => now()->subDays(8), 'statut' => 'termine', 'motif' => 'Migraines fréquentes', 'patient_id' => $patients[4]->id, 'medecin_id' => $medNeuro->id]);
        ...
        $rdv7 = RendezVous::create(['date_heure' => now()->subDays(4), 'statut' => 'termine', 'motif' => 'Baisse de vision', 'patient_id' => $patients[6]->id, 'medecin_id' => $medOphtalmo->id]);
        ...
        $rdv8 = RendezVous::create(['date_heure' => now()->subDays(2), 'statut' => 'termine', 'motif' => 'Douleurs articulaires', 'patient_id' => $patients[7]->id, 'medecin_id' => $medRhumato->id]);
