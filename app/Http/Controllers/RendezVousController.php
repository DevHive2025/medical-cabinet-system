...
// 3. Ajouter cette fonction pour récupérer les créneaux d'un jour précis :
    ...
    public function store(Request $request)
    {
        ...
        $urlConfirmation = \Illuminate\Support\Facades\URL::temporarySignedRoute(
        ...
        \Illuminate\Support\Facades\Mail::to($emailDestinataire)->send(new \App\Mail\ConfirmationRdvMail($rdv, $urlConfirmation));
